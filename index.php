...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Ar&#244;mes Saint-Germain - Comming soon</title>
        ...
        <div class="container">
            <div class="header row">
                <div class="logo span4">
                    <h1><a href="">Ar&#244;mes Saint-Germain</a> <span>.</span></h1>
                </div>
                <div class="call-us span8">
                    <p>
						Tel: <span>(+216) 98 422 040</span> | 
						E-mail: <span>contact@aromes-saint-germain.com </span>
					</p>
                </div>
            </div>
        </div>
        ...
        <div class="coming-soon">
            <div class="inner-bg">
                <div class="container">
                    <div class="row">
                        <div class="span12">
                            <h2>Ar&#244;mes Saint Germain</h2>
                            <p>Production, Vente et Distribution des Huiles Essentielles</p>
							<p>Adresse: 10- Rue Ibnou Hani-Ez-zahra 2034 Tunisie</p>
                            <div class="timer">
                                <div class="days-wrapper">
                                    <span class="days"></span> <br>jours
                                </div>
                                <div class="hours-wrapper">
                                    <span class="hours"></span> <br>heures
                                </div>
                                <div class="minutes-wrapper">
                                    <span class="minutes"></span> <br>minutes
                                </div>
                                <div class="seconds-wrapper">
                                    <span class="seconds"></span> <br>secondes
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="span12 subscribe">
                    ...
                    <p>Inscrit maintenant et vous serez le premier de savoir les nouvelles:</p>
